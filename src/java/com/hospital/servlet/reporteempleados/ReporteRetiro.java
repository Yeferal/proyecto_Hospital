 ...
 * @author yefer
 */
@WebServlet(name = "ReporteRetiro", urlPatterns = {"/ReporteRetiro"})
public class ReporteRetiro extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("datos", reporte.listarEmpleadosRetiro("", "NOW()", "'0'"));
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("objetoarea", listas.listarAreas());
        request.setAttribute("datos", reporte.listarEmpleadosRetiro(texto, fecha1, fecha2));
        RequestDispatcher dispatcher = request.getRequestDispatcher("page-reporte2-empleados.jsp");
        dispatcher.forward(request, response);
    }
